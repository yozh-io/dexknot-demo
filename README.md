...
|         **`provider`**          | `Eip1193Provider or JsonRpcProvider or Web3Provider`                                                                          | In order for a software application to interact with the blockchain, it must connect to provider. Widget uses own provider if this prop is not passed.                                                                                                                                                                                   | `undefined`                                                                                                                                                                                                                                                               |
